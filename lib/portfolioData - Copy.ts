...
export const skillsData = {
  languages: [
    { name: "C#", description: "Primary language for .NET development, writing clean, type-safe backend logic." },
    { name: "TypeScript", description: "Writing scalable, robust frontend and backend code with static typing." },
    { name: "JavaScript", description: "The core of the web, used for dynamic behaviors and legacy support." },
    { name: "Python", description: "Used for AI/ML scripts, automation tools, and fast prototyping." },
    { name: "Java", description: "Strong foundation in object-oriented programming and enterprise systems." },
    { name: "PHP", description: "Experience with server-side scripting for legacy web applications." },
    { name: "Bash", description: "Scripting for CI/CD pipelines and server management." },
    { name: "Markdown", description: "Documentation and content formatting." }
  ],
  backend: [
    { name: ".NET", description: "Building high-performance, cross-platform applications." },
    { name: "ASP.NET Core", description: "Creating robust APIs and web applications." },
    { name: "Entity Framework Core", description: "ORM for efficient database operations in .NET." },
    { name: "REST APIs", description: "Designing and consuming standard web API protocols." },
    { name: "Microservices", description: "Architecting scalable, distributed systems." },
    { name: "RabbitMQ", description: "Implementing message brokerage for event-driven systems." },
    { name: "Ocelot API Gateway", description: "Managing request routing and authentication." },
    { name: "Clean Architecture", description: "Enforcing separation of concerns for maintainable code." },
    ...
    { name: "Node.js", description: "JavaScript runtime for building scalable network applications." },
    { name: "Express.js", description: "Minimalist web framework for Node.js." }
  ],
  frontend: [
    { name: "React", description: "Building interactive user interfaces with components." },
    { name: "Next.js", description: "Production React framework for SSR and static generation." },
    { name: "Three.js", description: "Creating 3D visuals and experiences in the browser." },
    { name: "Tailwind CSS", description: "Rapid UI development with utility-first CSS." },
    { name: "Bootstrap", description: "Responsive grid layouts and components." },
    { name: "Blazor", description: "Building interactive web UIs with C#." },
    { name: "HTML", description: "Semantic structure of web pages." },
    { name: "CSS", description: "Styling and layout of web pages." }
  ],
  databases: [
    { name: "PostgreSQL", description: "Advanced open-source relational database." },
    { name: "SQL Server (T-SQL)", description: "Enterprise-grade relational database management." },
    { name: "MongoDB", description: "NoSQL database for flexible data schemas." },
    ...
    { name: "Firebase", description: "Platform for building mobile and web applications." },
    { name: "Oracle", description: "Multi-model database management system." },
    { name: "SQLite", description: "Self-contained, serverless SQL database engine." }
  ],
  devops: [
    { name: "Docker", description: "Containerizing applications for consistent deployment." },
    { name: "CI/CD (Azure DevOps)", description: "Automating build, test, and deployment pipelines." },
    { name: "Version Control (Git)", description: "Tracking changes and coordinating work." },
    { name: "Jenkins", description: "Open source automation server." },
  ],
  tools: [
    { name: "Visual Studio", description: "Comprehensive IDE for .NET development." },
    { name: "VS Code", description: "Lightweight, powerful code editor." },
    { name: "Android Studio", description: "IDE for Android app development." },
    { name: "Postman", description: "API development and testing tool." },
    { name: "Obsidian", description: "Knowledge base and note-taking app." },
    ...
    { name: "GitHub", description: "Hosting for software development and version control." },
    { name: "Vercel", description: "Platform for frontend frameworks and static sites." },
    { name: "Render", description: "Cloud application hosting platform." },
    { name: "Netlify", description: "Web development platform." },
    { name: "JIRA", description: "Issue tracking and project management." },
    { name: "Trello", description: "Visual collaboration tool." },
    { name: "OpenProject", description: "Web-based project management system." }
  ],
  machineLearning: [
    { name: "OpenAI", description: "Integration with GPT models." },
    { name: "HuggingFace", description: "Platform for sharing machine learning models." },
    ...
    { name: "NumPy", description: "Library for large, multi-dimensional arrays." }
  ],
  architecture: [
    { name: "Clean Architecture", description: "Software architecture for decoupling concerns." },
    { name: "Layered Architecture", description: "Organizing code into logical layers." },
    { name: "Microservices Architecture", description: "Structuring an app as a collection of services." },
    { name: "Meta Data Driven Architecture", description: "Using metadata to drive application behavior." }
  ]
};
